...
public:
  struct ParaMB {
    ...
    std::vector<double> rc_angular_pair;
    std::vector<double> rcinv_angular_pair;
    std::vector<double> zbl_zizj_pair;
    std::vector<double> zbl_a_inv_pair;
    std::vector<double> zbl_rc_inner_pair;
    std::vector<double> zbl_rc_outer_pair;
#ifdef USE_TABLE_FOR_RADIAL_FUNCTIONS
    std::vector<int> table_pair_to_slot;
    std::size_t table_pair_count = 0;
#endif
  };
  ...
  std::vector<int> lammps_angular_edge_neighbors;
  std::vector<double> lammps_angular_edge_x12;
  std::vector<double> lammps_angular_edge_y12;
  std::vector<double> lammps_angular_edge_z12;
  std::vector<double> lammps_angular_edge_d12;
  std::vector<double> lammps_angular_edge_gn;
  std::vector<double> lammps_angular_edge_gnp;
  std::vector<int> lammps_radial_edge_offsets;
  std::vector<int> lammps_radial_edge_neighbors;
  std::vector<double> lammps_radial_edge_x12;
  std::vector<double> lammps_radial_edge_y12;
  ...
  void prepare_table_for_lammps(
    ...
    const int* g_type,
    const int* type_map);
  void construct_table(const std::vector<char>& active_pairs);
#endif
